...
class KISPE_MCP2515 : public CANControllerClass {

public:
  KISPE_MCP2515(int8_t cspin, SPIClass *theSPI = &SPI);
  KISPE_MCP2515(int8_t cspin, int8_t mosipin, int8_t misopin, int8_t sckpin);
  virtual ~KISPE_MCP2515();
...
private:
  ...
  void readAllReceiveRegisters(uint8_t address, uint8_t* receiveBuffer);
  void modifyRegister(uint8_t address, uint8_t mask, uint8_t value);
  void writeRegister(uint8_t address, uint8_t value);

  static KISPE_MCP2515 *instance;
